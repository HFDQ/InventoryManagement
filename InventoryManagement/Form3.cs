...
namespace InventoryManagement
{
	public class Form3 : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Location = new Point(216, 9);
			this.textBox1.Margin = new Padding(4, 4, 4, 4);
			this.textBox1.Name = "textBox1";
			this.textBox1.Size = new Size(242, 28);
			this.textBox1.TabIndex = 1;
			this.button1.Location = new Point(316, 456);
			...
			this.label2.Location = new Point(44, 58);
			...
			base.ClientSize = new Size(490, 500);
